 ...
 * @version 1.0
 */
public abstract class ApplicationGlobalConstants extends AbstractConstants {

	/**
	 * Spring的ROOT上下文,由@{link org.springframework.web.context.ContextLoaderListener}加载出来的spring上下文
	 */
	public static final Constant<ApplicationContext> ROOT_APPLICATION_CONTEXT = valueOf(null);
