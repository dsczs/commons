...
import com.penglecode.common.support.ServletContextAttribute;
...
/**
 * 将标有@ServletContextAttribute注解的系统常量set到ServletContext.attributes中去
 *
 ...
 */
public class ServletContextAttributesInitializer extends AbstractApplicationInitializer {

    private static final Logger logger = LoggerFactory.getLogger(ServletContextAttributesInitializer.class);
